...
- 真实公开影像来源记录，运行时使用本地 `public/textures/` 素材。
...
太阳、行星和月球视觉素材来自 NASA 官方页面或 NASA Images 服务，来源记录见 `docs/assets.md` 和 `src/data/assets.ts`。当前素材以代表性官方影像为主，并非全部都是严格的 equirectangular global texture；具体处理方式逐项记录在素材表中。
